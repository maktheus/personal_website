  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at top left, rgba(234,242,5,0.05) 0%, transparent 70%)",
        }}
      />
      ...
      <p className="text-sm mb-4" style={{ color: "var(--text-muted)", lineHeight: "1.65" }}>
      ...
      <div className="flex gap-4 mt-auto pt-2">
        ...
        {project.liveUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs font-mono flex items-center gap-1.5 transition-colors duration-200"
